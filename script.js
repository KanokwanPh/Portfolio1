...
const projectDetails = {
  ...
  "coffee-qa": {
    "title": "Coffee Shop Ordering — จำลองการทดสอบ QA ด้วย AI",
    "category": "การทดสอบซอฟต์แวร์และวิศวกรรม QA",
    "subtitle": "ใช้ AI สร้างต้นแบบกระบวนการทดสอบระบบสั่งซื้อกาแฟออนไลน์ ตั้งแต่การวิเคราะห์ข้อกำหนด SRS การจัดทำ Test Case และ RTM ไปจนถึงการสร้างตัวอย่างรายงานข้อบกพร่อง",
    "badges": [
      "AI ช่วยสร้างเนื้อหาและเอกสาร",
      "SRS Analysis",
      "Test Case",
      "RTM",
      "Bug Report",
    ...
    "demo": "#",
    "summary": "โปรเจกต์จำลองกระบวนการทดสอบระบบสั่งซื้อกาแฟออนไลน์ โดยใช้ AI ช่วยสร้างเอกสารและตัวอย่างการทดสอบตามข้อกำหนด SRS ครอบคลุมการออกแบบ Test Case การจัดทำตารางติดตามความต้องการ (RTM) และการจำลองรายงานข้อบกพร่อง เพื่อศึกษาแนวทางการทำงานด้าน Software Testing & QA",
    "keyContributions": [
      "ใช้ AI ช่วยสร้างตัวอย่างการวิเคราะห์ข้อกำหนด SRS และเงื่อนไขการทำงานของระบบ", 
      "ใช้ AI ช่วยสร้าง Test Case สำหรับจำลองสถานการณ์การทดสอบระบบสั่งซื้อกาแฟ",
      "สร้างตัวอย่างตาราง RTM เพื่อแสดงความเชื่อมโยงระหว่างข้อกำหนดกับ Test Case",
      "ใช้ AI ช่วยสร้างตัวอย่างรายงานข้อบกพร่อง โดยระบุระดับความรุนแรง ขั้นตอนการจำลองปัญหา และผลลัพธ์ที่คาดหวัง"
    ],
    "artifacts": null
  },
  "shareu": {
  ...
  "todolist-qa": {
    "title": "TodoList-QA — จำลองการทดสอบเว็บแอปด้วย AI",
    "category": "การทดสอบซอฟต์แวร์และวิศวกรรม QA",
    "subtitle": "ใช้ AI สร้างตัวอย่างการทดสอบเว็บแอป Todo List ครอบคลุมการทดสอบการทำงาน การตรวจสอบ DOM และการจัดทำรายงานข้อบกพร่อง",
    "badges": [
      "AI ช่วยสร้างตัวอย่างการทดสอบ",
      "Python",
      "Test Case",
      "BeautifulSoup4",
      "DOM Testing",
    ...
    "demo": "#",
    "summary": "โปรเจกต์จำลองการทดสอบ QA สำหรับเว็บแอป Todo List โดยใช้ AI ช่วยสร้างสถานการณ์ทดสอบ 10 กรณี ครอบคลุมการเพิ่ม ลบ และแก้ไขรายการ รวมถึงตัวอย่างการทดสอบ DOM และ Smoke Test ด้วย Python พร้อมตัวอย่างรายงานข้อบกพร่อง 5 รายการ เพื่อศึกษาแนวทางการทดสอบซอฟต์แวร์",
    "keyContributions": [
      "ใช้ AI ช่วยสร้างตัวอย่าง Test Case สำหรับจำลองการทดสอบเว็บแอป Todo List จำนวน 10 กรณี", 
      "ใช้ AI ช่วยสร้างตัวอย่างแนวทางการตรวจสอบ DOM และ Smoke Test ด้วย Python",
      "สร้างตัวอย่างรายงานข้อบกพร่อง 5 รายการ ครอบคลุมปัญหาการทำงานของระบบและการตรวจสอบข้อมูล",
      "จัดทำเอกสารรายงานข้อบกพร่อง โดยระบุระดับความรุนแรง ขั้นตอนการจำลองปัญหา และผลลัพธ์ที่คาดหวัง"
    ],
    "artifacts": null
  },
  "littlekids": {
